...
#  STEP 1 — SHOW current content in /content
!echo "==== /content listing ===="
!ls -la /content


#  STEP 2 — CREATE project folder if missing

!mkdir -p /content/scene-recognition-system
!echo "Created /content/scene-recognition-system (if not present)"


#  STEP 3 — MOVE existing project files into the folder (no overwrite)
...
#  STEP 4 — SHOW the final folder structure
...
#  STEP 6 — OPTIONAL: Clean notebook metadata (for GitHub preview)


import nbformat

input_path = "train.ipynb"              # main notebook name
output_path = "train_clean.ipynb"       # cleaned version

# Read notebook file
with open(input_path) as f:
    nb = nbformat.read(f, as_version=4)

# Remove invalid Colab metadata
...
#  STEP 7 — VERIFY cleaned notebook

!ls -lh | grep train_clean


# STEP 8 — REPLACE original notebook with cleaned one

!mv train_clean.ipynb train.ipynb


#  STEP 9 — FINAL PROJECT FOLDER CHECK

!echo "==== Final project folder contents ===="
